#!/bin/bash
# Wrapper script for running remaining Llama-3.1-8B experiments on HPC cluster
# Runs only semi_formal and low_formal with K=5 (high_formal already completed)
