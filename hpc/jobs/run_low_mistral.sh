#!/bin/bash
# Run low-formal management decision tasks with Mistral-7B (4-bit, K=5)
...
echo ""
echo "=== Running low_formal (Mistral-7B, 4-bit, K=5) ==="
...
ls -la data/results_raw/low_formal_mistral*
wc -l data/results_raw/low_formal_mistral_7b.jsonl
