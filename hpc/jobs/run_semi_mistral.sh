#!/bin/bash
# Run semi-formal legal clause tasks with Mistral-7B (4-bit quantization)
...
echo ""
echo "=== Running semi_formal (Mistral-7B, 4-bit, K=5) ==="
...
ls -la data/results_raw/semi_formal_mistral*
wc -l data/results_raw/semi_formal_mistral_7b.jsonl
