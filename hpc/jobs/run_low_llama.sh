#!/bin/bash
# Run low-formal management decision tasks with Llama-3.1-8B (FP16, K=5)
...
ls -la data/results_raw/low_formal_llama*
wc -l data/results_raw/low_formal_llama_3_1_8b.jsonl
